...
/**
 * Test {@link QuadraticLeftZeroRateCurveExtrapolator}.
 */
@Test
public class QuadraticLeftZeroRateCurveExtrapolatorTest {

  private static final CurveExtrapolator QL_EXTRAPOLATOR =
      QuadraticLeftZeroRateCurveExtrapolator.INSTANCE;
  ...
  public void test_basics() {
    assertEquals(QL_EXTRAPOLATOR.getName(), QuadraticLeftZeroRateCurveExtrapolator.NAME);
    assertEquals(QL_EXTRAPOLATOR.toString(), QuadraticLeftZeroRateCurveExtrapolator.NAME);
  }
  ...
  public void sameIntervalsTest() {
    ...
    for (int k = 0; k < yDim; ++k) {
      BoundCurveInterpolator bci = CurveInterpolators.LOG_NATURAL_SPLINE_MONOTONE_CUBIC.bind(
          xValues, yValues[k], QL_EXTRAPOLATOR, CurveExtrapolators.LOG_LINEAR);
...
//              Math.max(Math.abs(yValues[k].get(j)) * EPS, EPS) * 1.e2);//because gradient is NOT exact  TODO
        }
  ...
  public void differentIntervalsTest() {
    DoubleArray xValues = DoubleArray.of(
        ...
        7.011992052151352,
        7.293354144919639, 8.557971037612713, 8.77306861567384, 10.572470371584489,
        12.96945799507056);
    DoubleArray[] yValues = new DoubleArray[] {
        DoubleArray.of(1.1593075755231343, 2.794957672828094, 4.674733634811079, 5.517689918508841,
            6.138447304104604,
            6.264375977142906, 6.581666492568779, 8.378685055774037, 10.005246918325483,
            10.468304334744241),
        DoubleArray.of(9.95780079114617, 8.733013195721913, 8.192165283188197, 6.539369493529048,
            6.3868683960757515,
            4.700471352238411, 4.555354921077598, 3.780781869340659, 2.299369456202763,
            0.9182441378327986)
    };
    int nData = xValues.size();
    int nKeys = 100 * nData;
