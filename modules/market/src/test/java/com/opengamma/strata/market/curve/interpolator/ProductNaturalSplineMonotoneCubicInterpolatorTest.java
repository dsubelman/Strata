...
public class ProductNaturalSplineMonotoneCubicInterpolatorTest {
  ...
  private static final PiecewisePolynomialInterpolator BASE_INTERP =
      new MonotonicityPreservingCubicSplineInterpolator(new LogNaturalSplineHelper());
  private static final PiecewisePolynomialWithSensitivityFunction1D FUNCTION =
  ...
  public void sampleDataTest() {
    ...
    PiecewisePolynomialResultsWithSensitivity ppRes =
        BASE_INTERP.interpolateWithSensitivity(xValues.toArray(), pValues.toArray());
